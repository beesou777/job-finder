/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 97cbd46833d663aad964624ffc487000)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_SANITY_ORGANIZATION_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEXT_PUBLIC_SANITY_PROJECT_ID" | "NEXT_PUBLIC_SANITY_DATASET" | "NEXT_PUBLIC_SANITY_ORGANIZATION_ID" | "OPENROUTER_MODEL" | "OPENROUTER_API_KEY">> {}
}
