      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2 flex flex-row items-center justify-between">
            ...
            <Badge
              variant="secondary"
              className="text-[9px] py-0 bg-amber-50 text-amber-600 border-amber-100"
            >
              7ms Latency
            </Badge>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2">
              <div
                className={`h-3 w-3 rounded-full ${isScraping ? "bg-yellow-500 animate-pulse" : "bg-green-500"}`}
              />
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="w-24 h-2 bg-slate-200 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(source.count / (analyticsData.overview?.totalJobs?.value || 1)) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
