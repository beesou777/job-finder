    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Central directory of all administrative modules and tools.</p>
            </div>
            ...
            <Card className="bg-slate-50 border-dashed border-2">
                <CardContent className="py-12 text-center text-muted-foreground">
                    <p className="text-sm">Additional modules can be registered via the `NavigationData.ts` schema.</p>
                </CardContent>
            </Card>
        </div>
    );
