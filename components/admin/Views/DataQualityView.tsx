    ...
    return (
        <div className="space-y-6">
             <div>
                ...
                <p className="text-muted-foreground">System health, anomaly detection, and data integrity.</p>
            </div>
                        ...
                        {alerts.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {alerts.map((alert: any) => (
                                    <div key={alert.id} className="p-4 rounded-lg bg-orange-50 border border-orange-100 text-orange-900 dark:bg-orange-900/10 dark:text-orange-100 dark:border-orange-800">
                    ...
                    <CardContent>
                         <div className="flex items-center justify-center py-6">
                             <div className="relative h-32 w-32 flex items-center justify-center rounded-full border-8 border-slate-100 dark:border-slate-800">
                                <span className="text-3xl font-bold">{analyticsData.overview?.completenessScore}%</span>
                             </div>
                         </div>
