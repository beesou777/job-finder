    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Export raw data and generate specialized insight reports.</p>
            </div>
                            ...
                            <tbody>
                                {(() => {
                                    ...
                                    const getDemandLevel = (count: number) => {
                                        ...
                                        if (ratio > 0.6) return { label: "High Demand", color: "text-green-600", bg: "bg-green-100" };
                                        if (ratio > 0.3) return { label: "Medium Demand", color: "text-yellow-600", bg: "bg-yellow-100" };
                                ...
                                {categories.length === 0 && (
                                    <tr>
                                        <td colSpan={3} className="px-4 py-8 text-center text-muted-foreground">Loading category data...</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
