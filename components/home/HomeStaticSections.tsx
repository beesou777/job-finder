...
function FeatureCard({ icon, title, description, meta }: { icon: React.ReactNode, title: string, description: string, meta: string }) {
  return (
          ...
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                return (
                  <div key={item.title} className="rounded-xl border border-white/10 bg-zinc-950/70 p-5">
