...
export async function detectCategoryFromJob(
  ...
  const categoryKeywords: Record<string, string[]> = {
    ...
    "Graphic Design": ["graphic design", "graphic designer", "photoshop", "illustrator", "adobe"],
    "Mobile Development": [
      "mobile",
      "android",
      "ios",
    ...
    "Software Development": [
      ...
      "mid-level kotlin multiplatform",
      "dot net developer",
    ],
    ...
    Accounting: ["accountant", "accounting", "accountancy", "bookkeeping", "audit"],
    Education: [
      "instructor",
      "teacher",
      "mentor",
      ...
      "data science with python instructor",
    ...
    "Event Management": ["event management", "event planner", "event coordinator"],
    "Game Development": ["game developer", "game development", "gaming", "unity", "unreal"],
    Security: [
      "security",
      "cybersecurity",
      "ethical hacking",
    ...
    Tourism: ["tourism", "travel", "hospitality", "lgbt tourism"],
