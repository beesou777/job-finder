...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  {
    url: absoluteUrl("/internships-in-nepal"),
    lastModified: new Date(),
    changeFrequency: "hourly",
    priority: 0.9,
  },
  {
    url: absoluteUrl("/it-jobs-nepal"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.85,
  },
  {
    url: absoluteUrl("/remote-jobs-nepal"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.85,
  },
  {
    url: absoluteUrl("/jobs-in-kathmandu"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.85,
  },
  {
    url: absoluteUrl("/jobs-in-pokhara"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.8,
  },
  {
    url: absoluteUrl("/banking-jobs-nepal"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.82,
  },
  {
    url: absoluteUrl("/marketing-jobs-nepal"),
    lastModified: new Date(),
    changeFrequency: "daily",
    priority: 0.8,
  },
  ...
  {
    url: absoluteUrl("/tools/salary-calculator-nepal"),
    lastModified: new Date(),
    changeFrequency: "monthly",
    priority: 0.6,
  },
  {
    url: absoluteUrl("/how-kamkhoj-works"),
    lastModified: new Date(),
    changeFrequency: "monthly",
    priority: 0.55,
  },
