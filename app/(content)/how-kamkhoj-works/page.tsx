      ...
      <section className="container mx-auto max-w-4xl px-4 py-14 md:py-16">
        <div className="rounded-xl border border-white/10 bg-[#18181a] p-6 md:p-10">
          ...
          <div className="mt-8 space-y-6 text-zinc-300 [&_h2]:pt-4 [&_h2]:text-2xl [&_h2]:font-black [&_h2]:text-white [&_p]:leading-7">
            <p>
              KamKhoj is a job discovery website for Nepal. It helps candidates
              search public vacancies from multiple sources in one place, compare
              options faster, and continue to the original source for the final
              application.
            </p>

            <h2>What KamKhoj Collects</h2>
            <p>
              KamKhoj organizes public listing details such as job title, company
              name, location, category, deadline, job type, and source link when
              those details are available on public pages.
            </p>

            <h2>What KamKhoj Does Not Do</h2>
            <p>
              KamKhoj is not a recruitment agency and does not replace the original
              employer or job portal. It does not complete applications for users
              and does not claim ownership of third-party job postings.
            </p>

            <h2>How Applications Work</h2>
            <p>
              Every application should be completed on the original source. Users
              should verify salary, eligibility, deadline, required documents, and
              instructions before applying or sharing personal information.
            </p>

            <h2>How Listings Are Updated</h2>
            <p>
              KamKhoj checks public sources regularly and tries to keep active
              listings visible while removing or de-emphasizing expired jobs when
              expiry information is available. Because source pages can change at
            ...
            <p>
              The goal is simple: reduce the time job seekers spend opening many
              portals just to compare public opportunities. KamKhoj focuses on
              faster discovery, clearer routing, and transparent source attribution.
            </p>
          </div>
