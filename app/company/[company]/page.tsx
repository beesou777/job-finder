    ...
    <div className="min-h-screen bg-[#070708] text-zinc-100">
      <section className="border-b border-white/10 bg-[radial-gradient(circle_at_80%_0%,rgba(166,255,70,0.12),transparent_32%)]">
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <p className="text-lg text-zinc-400 max-w-3xl leading-8">
            Browse active and related vacancies for {companyName}. KamKhoj links each
            job to the original source so candidates can verify details before applying.
          </p>
        </div>
      </section>
      <section className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center gap-2">
          ...
          <h2 className="text-2xl font-black text-zinc-50">Latest roles mentioning {companyName}</h2>
        </div>
